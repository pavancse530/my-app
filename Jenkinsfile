node{
   ...
   sh "docker login -u admin -p admin123 15.207.18.223:8083"
   sh "docker tag pavancse530/myweb:0.0.2 15.207.18.223:8083/pavan:1.0.0"
   sh 'docker push 15.207.18.223:8083/pavan:1.0.0'
   }
