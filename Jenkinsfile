node{
   ...
   sh "docker login -u admin -p ${NexusPassword} http://65.2.190.128:8083"
}
   sh "docker tag pavancse530/myweb:0.0.2 65.2.190.128:8083/pavan:1.0.0"
   sh 'docker push 65.2.190.128:8083/pavan:1.0.0'
   }
