node{
   ...
   sh "docker login -u admin -p ${NexusPassword} http://43.204.110.242:8083"
}
   sh "docker tag pavancse530/myweb:0.0.2 43.204.110.242:8083/pavan:1.0.0"
   sh 'docker push 43.204.110.242:8083/pavan:1.0.0'
   }
